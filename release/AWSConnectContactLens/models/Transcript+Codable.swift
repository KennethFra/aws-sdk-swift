...
extension ConnectContactLensClientTypes.Transcript: Swift.Codable {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let beginOffsetMillisDecoded = try containerValues.decode(Swift.Int.self, forKey: .beginOffsetMillis)
        beginOffsetMillis = beginOffsetMillisDecoded
        let endOffsetMillisDecoded = try containerValues.decode(Swift.Int.self, forKey: .endOffsetMillis)
