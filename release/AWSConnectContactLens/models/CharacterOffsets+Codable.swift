...
extension ConnectContactLensClientTypes.CharacterOffsets: Swift.Codable {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let beginOffsetCharDecoded = try containerValues.decode(Swift.Int.self, forKey: .beginOffsetChar)
        beginOffsetChar = beginOffsetCharDecoded
        let endOffsetCharDecoded = try containerValues.decode(Swift.Int.self, forKey: .endOffsetChar)
