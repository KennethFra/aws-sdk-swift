...
extension MediaConvertClientTypes.DvbSubDestinationSettings: Swift.Codable {
    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let applyFontColor = applyFontColor {
        ...
        if let hexFontColor = hexFontColor {
