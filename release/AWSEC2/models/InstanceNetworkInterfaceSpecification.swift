...
extension Ec2ClientTypes {
    ...
    public struct InstanceNetworkInterfaceSpecification: Swift.Equatable {
        ...
        /// The type of network interface. To create an Elastic Fabric Adapter (EFA), specify efa. For more information, see [Elastic Fabric Adapter](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/efa.html) in the Amazon Elastic Compute Cloud User Guide. Valid values: interface | efa
