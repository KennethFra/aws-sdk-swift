...
extension XRayClientTypes.SamplingRule: Swift.Codable {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let fixedRateDecoded = try containerValues.decode(Swift.Double.self, forKey: .fixedRate)
        fixedRate = fixedRateDecoded
        let reservoirSizeDecoded = try containerValues.decode(Swift.Int.self, forKey: .reservoirSize)
