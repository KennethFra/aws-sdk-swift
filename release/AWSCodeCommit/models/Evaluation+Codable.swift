...
extension CodeCommitClientTypes.Evaluation: Swift.Codable {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let approvedDecoded = try containerValues.decode(Swift.Bool.self, forKey: .approved)
        approved = approvedDecoded
        let overriddenDecoded = try containerValues.decode(Swift.Bool.self, forKey: .overridden)
