...
extension HoneycodeClientTypes.DelimitedTextImportOptions: Swift.Codable {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let hasHeaderRowDecoded = try containerValues.decode(Swift.Bool.self, forKey: .hasHeaderRow)
        hasHeaderRow = hasHeaderRowDecoded
        let ignoreEmptyRowsDecoded = try containerValues.decode(Swift.Bool.self, forKey: .ignoreEmptyRows)
