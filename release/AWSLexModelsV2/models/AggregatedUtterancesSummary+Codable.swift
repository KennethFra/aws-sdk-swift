...
extension LexModelsV2ClientTypes.AggregatedUtterancesSummary: Swift.Codable {
    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let containsDataFromDeletedResources = containsDataFromDeletedResources {
        ...
        if let missedCount = missedCount {
            try encodeContainer.encode(missedCount, forKey: .missedCount)
        }
        if let utterance = utterance {
            try encodeContainer.encode(utterance, forKey: .utterance)
        }
        if let utteranceFirstRecordedInAggregationDuration = utteranceFirstRecordedInAggregationDuration {
        ...
        if let utteranceLastRecordedInAggregationDuration = utteranceLastRecordedInAggregationDuration {
