...
extension LexModelsV2ClientTypes {
    ...
    public struct AssociatedTranscript: Swift.Equatable {
        /// The content of the transcript that meets the search filter criteria. For the JSON format of the transcript, see [Output transcript format](https://docs.aws.amazon.com/lex/latest/dg/designing-output-format.html).
