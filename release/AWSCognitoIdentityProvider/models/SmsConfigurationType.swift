...
extension CognitoIdentityProviderClientTypes {
    ...
    public struct SmsConfigurationType: Swift.Equatable {
        ...
        /// The Amazon Resource Name (ARN) of the Amazon Simple Notification Service (SNS) caller. This is the ARN of the IAM role in your account which Cognito will use to send SMS messages. SMS messages are subject to a [spending limit](https://docs.aws.amazon.com/cognito/latest/developerguide/user-pool-settings-email-phone-verification.html).
