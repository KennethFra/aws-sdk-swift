...
extension CreateUserPoolClientInputBody: Swift.Decodable {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let generateSecretDecoded = try containerValues.decode(Swift.Bool.self, forKey: .generateSecret)
        generateSecret = generateSecretDecoded
        let refreshTokenValidityDecoded = try containerValues.decode(Swift.Int.self, forKey: .refreshTokenValidity)
        ...
        let allowedOAuthFlowsUserPoolClientDecoded = try containerValues.decode(Swift.Bool.self, forKey: .allowedOAuthFlowsUserPoolClient)
