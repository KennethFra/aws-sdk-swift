...
extension CognitoIdentityProviderClientTypes.SchemaAttributeType: Swift.Codable {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let developerOnlyAttributeDecoded = try containerValues.decode(Swift.Bool.self, forKey: .developerOnlyAttribute)
        developerOnlyAttribute = developerOnlyAttributeDecoded
        let mutableDecoded = try containerValues.decode(Swift.Bool.self, forKey: .mutable)
