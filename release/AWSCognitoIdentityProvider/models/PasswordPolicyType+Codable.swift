...
extension CognitoIdentityProviderClientTypes.PasswordPolicyType: Swift.Codable {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let minimumLengthDecoded = try containerValues.decode(Swift.Int.self, forKey: .minimumLength)
        minimumLength = minimumLengthDecoded
        let requireUppercaseDecoded = try containerValues.decode(Swift.Bool.self, forKey: .requireUppercase)
        requireUppercase = requireUppercaseDecoded
        let requireLowercaseDecoded = try containerValues.decode(Swift.Bool.self, forKey: .requireLowercase)
        ...
        let temporaryPasswordValidityDaysDecoded = try containerValues.decode(Swift.Int.self, forKey: .temporaryPasswordValidityDays)
