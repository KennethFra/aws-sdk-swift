...
extension CognitoIdentityProviderClientTypes.UserImportJobType: Swift.Codable {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let importedUsersDecoded = try containerValues.decode(Swift.Int.self, forKey: .importedUsers)
        importedUsers = importedUsersDecoded
        let skippedUsersDecoded = try containerValues.decode(Swift.Int.self, forKey: .skippedUsers)
        skippedUsers = skippedUsersDecoded
        let failedUsersDecoded = try containerValues.decode(Swift.Int.self, forKey: .failedUsers)
