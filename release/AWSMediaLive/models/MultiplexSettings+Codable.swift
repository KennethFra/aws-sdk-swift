...
extension MediaLiveClientTypes.MultiplexSettings: Swift.Codable {
    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let maximumVideoBufferDelayMilliseconds = maximumVideoBufferDelayMilliseconds {
            try encodeContainer.encode(maximumVideoBufferDelayMilliseconds, forKey: .maximumVideoBufferDelayMilliseconds)
        }
        if let transportStreamBitrate = transportStreamBitrate {
        ...
        if let transportStreamReservedBitrate = transportStreamReservedBitrate {
