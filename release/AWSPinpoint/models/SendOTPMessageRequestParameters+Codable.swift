...
extension PinpointClientTypes.SendOTPMessageRequestParameters: Swift.Codable {
    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let allowedAttempts = allowedAttempts {
        ...
        if let destinationIdentity = destinationIdentity {
        ...
        if let originationIdentity = originationIdentity {
        ...
        if let validityPeriod = validityPeriod {
