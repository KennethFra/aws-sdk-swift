...
extension CodeDeployClientTypes.DeploymentInfo: Swift.Codable {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let ignoreApplicationStopFailuresDecoded = try containerValues.decode(Swift.Bool.self, forKey: .ignoreApplicationStopFailures)
        ...
        let updateOutdatedInstancesOnlyDecoded = try containerValues.decode(Swift.Bool.self, forKey: .updateOutdatedInstancesOnly)
        ...
        let instanceTerminationWaitTimeStartedDecoded = try containerValues.decode(Swift.Bool.self, forKey: .instanceTerminationWaitTimeStarted)
