...
public struct DescribeTypeOutputResponse: Swift.Equatable {
    ...
    /// The schema that defines the extension. For more information on extension schemas, see [Resource Provider Schema](https://docs.aws.amazon.com/cloudformation-cli/latest/userguide/resource-type-schema.html) in the CloudFormation CLI User Guide.
