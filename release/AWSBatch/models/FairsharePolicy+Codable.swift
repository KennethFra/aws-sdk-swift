...
extension BatchClientTypes.FairsharePolicy: Swift.Codable {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let shareDecaySecondsDecoded = try containerValues.decode(Swift.Int.self, forKey: .shareDecaySeconds)
        shareDecaySeconds = shareDecaySecondsDecoded
        let computeReservationDecoded = try containerValues.decode(Swift.Int.self, forKey: .computeReservation)
