...
extension SecurityHubClientTypes.AwsEcsTaskDefinitionContainerDefinitionsHealthCheckDetails: Swift.Codable {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let retriesDecoded = try containerValues.decode(Swift.Int.self, forKey: .retries)
        retries = retriesDecoded
        let startPeriodDecoded = try containerValues.decode(Swift.Int.self, forKey: .startPeriod)
