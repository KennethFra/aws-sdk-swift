...
extension SecurityHubClientTypes.AwsAutoScalingLaunchConfigurationDetails: Swift.Codable {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let associatePublicIpAddressDecoded = try containerValues.decode(Swift.Bool.self, forKey: .associatePublicIpAddress)
        ...
        let ebsOptimizedDecoded = try containerValues.decode(Swift.Bool.self, forKey: .ebsOptimized)
