...
extension SecurityHubClientTypes.AwsEcsServiceDeploymentConfigurationDetails: Swift.Codable {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let maximumPercentDecoded = try containerValues.decode(Swift.Int.self, forKey: .maximumPercent)
        maximumPercent = maximumPercentDecoded
        let minimumHealthyPercentDecoded = try containerValues.decode(Swift.Int.self, forKey: .minimumHealthyPercent)
