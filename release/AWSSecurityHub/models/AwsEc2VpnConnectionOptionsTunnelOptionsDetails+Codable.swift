...
extension SecurityHubClientTypes.AwsEc2VpnConnectionOptionsTunnelOptionsDetails: Swift.Codable {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let dpdTimeoutSecondsDecoded = try containerValues.decode(Swift.Int.self, forKey: .dpdTimeoutSeconds)
        ...
        let phase1LifetimeSecondsDecoded = try containerValues.decode(Swift.Int.self, forKey: .phase1LifetimeSeconds)
        ...
        let phase2LifetimeSecondsDecoded = try containerValues.decode(Swift.Int.self, forKey: .phase2LifetimeSeconds)
        ...
        let rekeyFuzzPercentageDecoded = try containerValues.decode(Swift.Int.self, forKey: .rekeyFuzzPercentage)
        rekeyFuzzPercentage = rekeyFuzzPercentageDecoded
        let rekeyMarginTimeSecondsDecoded = try containerValues.decode(Swift.Int.self, forKey: .rekeyMarginTimeSeconds)
        rekeyMarginTimeSeconds = rekeyMarginTimeSecondsDecoded
        let replayWindowSizeDecoded = try containerValues.decode(Swift.Int.self, forKey: .replayWindowSize)
