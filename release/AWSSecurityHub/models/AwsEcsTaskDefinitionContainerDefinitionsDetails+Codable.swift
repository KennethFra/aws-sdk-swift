...
extension SecurityHubClientTypes.AwsEcsTaskDefinitionContainerDefinitionsDetails: Swift.Codable {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let cpuDecoded = try containerValues.decode(Swift.Int.self, forKey: .cpu)
        cpu = cpuDecoded
        ...
        let disableNetworkingDecoded = try containerValues.decode(Swift.Bool.self, forKey: .disableNetworking)
        ...
        let essentialDecoded = try containerValues.decode(Swift.Bool.self, forKey: .essential)
        ...
        image = imageDecoded
        let interactiveDecoded = try containerValues.decode(Swift.Bool.self, forKey: .interactive)
        ...
        let memoryReservationDecoded = try containerValues.decode(Swift.Int.self, forKey: .memoryReservation)
        ...
        let pseudoTerminalDecoded = try containerValues.decode(Swift.Bool.self, forKey: .pseudoTerminal)
        ...
        let startTimeoutDecoded = try containerValues.decode(Swift.Int.self, forKey: .startTimeout)
        startTimeout = startTimeoutDecoded
        let stopTimeoutDecoded = try containerValues.decode(Swift.Int.self, forKey: .stopTimeout)
