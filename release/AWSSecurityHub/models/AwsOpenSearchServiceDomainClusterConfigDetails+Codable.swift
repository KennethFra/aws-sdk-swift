...
extension SecurityHubClientTypes.AwsOpenSearchServiceDomainClusterConfigDetails: Swift.Codable {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let warmEnabledDecoded = try containerValues.decode(Swift.Bool.self, forKey: .warmEnabled)
        warmEnabled = warmEnabledDecoded
        let warmCountDecoded = try containerValues.decode(Swift.Int.self, forKey: .warmCount)
        warmCount = warmCountDecoded
        let dedicatedMasterEnabledDecoded = try containerValues.decode(Swift.Bool.self, forKey: .dedicatedMasterEnabled)
        ...
        let dedicatedMasterCountDecoded = try containerValues.decode(Swift.Int.self, forKey: .dedicatedMasterCount)
        ...
        let zoneAwarenessEnabledDecoded = try containerValues.decode(Swift.Bool.self, forKey: .zoneAwarenessEnabled)
