...
extension SecurityHubClientTypes.AwsCodeBuildProjectArtifactsDetails: Swift.Codable {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let encryptionDisabledDecoded = try containerValues.decode(Swift.Bool.self, forKey: .encryptionDisabled)
        ...
        let overrideArtifactNameDecoded = try containerValues.decode(Swift.Bool.self, forKey: .overrideArtifactName)
